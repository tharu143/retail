...
function Home() {
    ...
    const completePayment = async () => {
        ...
        if (hasCreditPayment && selectedCustomer?.customer_group !== 'Credit Customer') {
            Swal.fire('Error', 'Only Customers belonging to the "Credit Customer" group are permitted to check out on Credit.', 'error');
            return;
        }
                            ...
                            {!selectedPaymentMode ? (
                                <>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        {selectedCustomer?.customer_group === 'Credit Customer' && (
                                            <button
        ...
        const handleKeyDown = (e) => {
            ...
            if (showPaymentModal) {
                if (!selectedPaymentMode) {
                    ...
                    } else if (e.key === '5' && selectedCustomer?.customer_group === 'Credit Customer') {
                        e.preventDefault();
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            <div style={{ display: 'flex', justifyContent: 'center', gap: '5px' }}>
                                                {billItems.length > 0 && <button className="home-bill-clear-btn" onClick={clearBillHandler}>Clear Bill</button>}
