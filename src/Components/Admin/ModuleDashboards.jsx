...
export const ProcurementDashboard = ({ metrics, charts, startDate, setStartDate, endDate, setEndDate, selectedBranch, setSelectedBranch, isAdmin, branches }) => (
  <div className="dashboard-modern-container">
    <div className="max-w-7xl mx-auto">
      ...
      <FilterBar startDate={startDate} setStartDate={setStartDate} endDate={endDate} setEndDate={setEndDate} selectedBranch={selectedBranch} setSelectedBranch={setSelectedBranch} isAdmin={isAdmin} branches={branches} />
...
export const SalesReturnsDashboard = ({ metrics, charts, startDate, setStartDate, endDate, setEndDate, selectedBranch, setSelectedBranch, isAdmin, branches }) => (
  <div className="dashboard-modern-container">
    <div className="max-w-7xl mx-auto">
      <header className="dashboard-header">
        <div className="welcome-text">
...
export const StockManagementDashboard = ({ metrics, charts, startDate, setStartDate, endDate, setEndDate, selectedBranch, setSelectedBranch, isAdmin, branches }) => (
  <div className="dashboard-modern-container">
    <div className="max-w-7xl mx-auto">
      <header className="dashboard-header">
        <div className="welcome-text">
...
export const POSOperationsDashboard = ({ metrics, charts, startDate, setStartDate, endDate, setEndDate, selectedBranch, setSelectedBranch, isAdmin, branches }) => (
  <div className="dashboard-modern-container">
    <div className="max-w-7xl mx-auto">
      <header className="dashboard-header">
        <div className="welcome-text">
...
export const InventoryLogisticsDashboard = ({ metrics, charts, startDate, setStartDate, endDate, setEndDate, selectedBranch, setSelectedBranch, isAdmin, branches }) => (
  <div className="dashboard-modern-container">
    <div className="max-w-7xl mx-auto">
      <header className="dashboard-header">
        <div className="welcome-text">
