...
import { 
    ...
    ArrowRight, ChevronRight, FileText, Activity, Palette, Warehouse, ShieldAlert
} from 'lucide-react';
        ...
        <div className="so-page">
            ...
            <div className="so-page-header">
                <div>
                    ...
                    <p className="so-page-subtitle">{entries.length} STOCK ENTRIES INDEXED</p>
                </div>
            </div>
                        ...
                        <table className="so-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style={{ textAlign: 'right' }}>Posting Date</th>
